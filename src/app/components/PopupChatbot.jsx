...
import supersonicsAiAssistant from "@/models1/supersonicsAssistantModel";
...
const PopupChatbot = () => {
  ...
  const handleSend = async () => {
    ...
    try {
      ...
      const aiResponse = await supersonicsAiAssistant(input);
      ...
      {isOpen && (
        <div
          className={`fixed right-6 ${
            isMinimized
              ? "bottom-6 h-16 w-72"
              : "bottom-6 h-[500px] w-80 sm:w-96 lg:w-6/12"
