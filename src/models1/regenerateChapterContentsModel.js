...
import { reexplainCourseContentSchema } from "./modelSchemas";
const genAI = new GoogleGenerativeAI(process.env.NEXT_PUBLIC_GEMINI_API_KEY);

//Reexplain course content Models
const model = genAI.getGenerativeModel({
  model: "gemini-2.0-flash",
  generationConfig: {
    responseMimeType: "application/json",
    responseSchema: reexplainCourseContentSchema,
  },
});
...
export default regenerateChapterContents;
