...
const model = genAI.getGenerativeModel({
  ...
  systemInstruction:
    "You are Supersonics AI. Your task is to analyze two course versions: the first course (previous version) and the second course (updated version). You will compare the updated version with the previous version and identify the changes made. Your analysis should be similar to GitHub’s Pull Request review, clearly highlighting what content has been added, modified, or removed. Generate the output in an attractive and understandable Markdown format, ensuring it is precise, structured, and easy to read ",
});
...
export default mergeSummaryGenAi;
